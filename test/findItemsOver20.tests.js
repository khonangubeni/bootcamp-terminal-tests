...
describe('Find items over 20 test function', function () {
    ...
    it("Test uses [{name : 'orange', qty : 10},{name : 'kiwi', qty : 37},{name : 'watermelon', qty : 27},{name : 'berries', qty : 3},[{name : 'apples', qty : 10},{name : 'pears', qty : 37},{name : 'bananas', qty : 27},{name : 'apples', qty : 3}] as the list", function () {
        assert.deepEqual([{name : 'kiwi', qty : 37},{name : 'watermelon', qty : 27},{name : 'pears', qty : 37},{name : 'bananas', qty : 27}], findItemsOver20([{name : 'orange', qty : 10},{name : 'kiwi', qty : 37},{name : 'watermelon', qty : 27},{name : 'berries', qty : 3},
